...
<p align="center">
  <img src="image/preview-ring.png" alt="Codex Orbit 圆环预览" width="180" />
  <img src="image/preview-details.png" alt="Codex Orbit 悬浮详情" width="330" />
</p>
...
- 拖动圆周：调整悬浮窗大小。
- 拖动 Mini 状态条：自由调整位置，程序会自动记住最后位置。
- 右键圆环或 Mini 状态条：切换悬浮窗/Mini 展示、重新读取、切换置顶或退出。

切换到 Mini 展示后，首次会在任务栏通知区域上方显示紧凑的 `5h / 7d` 额度状态条；可以拖到屏幕上的任意位置，单击即可恢复圆形悬浮窗。
